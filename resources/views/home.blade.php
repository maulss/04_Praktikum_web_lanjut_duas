...
<head>
     ...
     <title>Muhammad Maulana Givari</title>
<!--
...
-->
     ...
     <!-- MAIN CSS -->
     <link rel="stylesheet" href="{{asset('front/css/templatemo-digital-trend.css')}}">
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                          <div class="hero-image" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <img src="{{asset('front/images/working-girl.png')}}" class="img-fluid" alt="working girl">
                          </div>
                        </div>
               ...
               <div class="row">
                    ...
                    <div class="col-lg-7 mx-auto col-md-10 col-12">
                         ...
                         <div class="about-image" data-aos="fade-up" data-aos-delay="200">
                          ...
                          <img src="{{asset('front/images/office.png')}}" class="img-fluid" alt="office">
                        </div>
                    </div>
                        ...
                        <h2 class="mb-5 text-center" data-aos="fade-up">
                         ...
                         <div class="owl-carousel owl-theme" id="project-slide">
                              <div class="item project-wrapper" data-aos="fade-up" data-aos-delay="100">
                                   <img src="{{asset('front/images/project/project-image01.jpg')}}" class="img-fluid" alt="project image">
                              ...
                              <div class="item project-wrapper" data-aos="fade-up">
                                   <img src="{{asset('front/images/project/project-image02.jpg')}}" class="img-fluid" alt="project image">
                              ...
                              <div class="item project-wrapper" data-aos="fade-up">
                                   <img src="{{asset('front/images/project/project-image03.jpg')}}" class="img-fluid" alt="project image">
                              ...
                              <div class="item project-wrapper" data-aos="fade-up">
                                   <img src="{{asset('front/images/project/project-image04.jpg')}}" class="img-fluid" alt="project image">
                              ...
                              <div class="item project-wrapper" data-aos="fade-up">
                                   <img src="{{asset('front/images/project/project-image05.jpg')}}" class="img-fluid" alt="project image">
               ...
               <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5 col-12">
                        <div class="contact-image" data-aos="fade-up">
                          ...
                          <img src="{{asset('front/images/female-avatar.png')}}" class="img-fluid" alt="website">
                        </div>
                    </div>
    ...
    <footer class="site-footer">
     ...
     <!-- SCRIPTS -->
     <!-- "{{asset('front/css/templatemo-digital-trend.css')}}" -->
     ...
     <script src="{{asset('front/rellax.min.js')}}"></script>
